  ...
  return (
    <AppShell>
      <PageHeader
        ...
        description="Monitor personal result freshness, market signal quality, top matches, and role-fit distribution from one user-scoped view."
      />
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        />
        <MetricCard
          helper="Latest successful personal result timestamp"
